...
class Parasite:
    ...
    def __init__(self, linktype=''):
        self.botIsOpen = 1
        self.botCacheBasePath = 'C:/firmwaresupport/kandle/'
        ...
        if linktype != '':
            if linktype == 'cache1':
                cache = 'kandle-cache1'
            elif linktype == 'cache2':
                cache = 'kandle-cache2'
            elif linktype == 'cache3':
                cache = 'kandle-cache3'
            else:
                cache = linktype
            chrome_options.add_argument(
            ...
            chrome_options.add_argument(
                f"user-data-dir={self.botCacheBasePath}kandle-cache1")
    ...
    def CrackedMindBot(self, url, open_only_browser=False):
        ...
        if self.retries == retries:
            self.end_url = replies.damage_error
        else:
            self.WalkOn()
    ...
    def WalkOn(self):
        ...
        if self.retries == retries:
            ...
            try:
                ...
                print('\a\a')
                self.end_url = replies.contact_with_adming
